...
func NewInviteUserToGroupHandler(giuc usecase.GroupInviteInterface, luuc usecase.ListUserInterface, ja authentication.JwtAuthentication) group.InviteUserToGroupHandler {
