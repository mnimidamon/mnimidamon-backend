...
// InviteUserToGroupParams contains all the bound params for the invite user to group operation
// typically these are obtained from a http.Request
//
// swagger:parameters inviteUserToGroup
type InviteUserToGroupParams struct {
	...
	/*Payload to invite a user
	  ...
	  In: body
	*/
	Body *modelapi.InviteUserPayload
...
//
// To ensure default values, the struct must have been initialized with NewInviteUserToGroupParams() beforehand.
func (o *InviteUserToGroupParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body modelapi.InviteUserPayload
...
func (o *InviteUserToGroupParams) bindGroupID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
