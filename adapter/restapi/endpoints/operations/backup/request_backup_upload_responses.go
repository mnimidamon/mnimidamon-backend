...
func (o *RequestBackupUploadBadRequest) WithPayload(payload *modelapi.Error) *RequestBackupUploadBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the request backup upload bad request response
func (o *RequestBackupUploadBadRequest) SetPayload(payload *modelapi.Error) {
	o.Payload = payload
}
...
func (o *RequestBackupUploadUnauthorized) WithPayload(payload *modelapi.Error) *RequestBackupUploadUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the request backup upload unauthorized response
func (o *RequestBackupUploadUnauthorized) SetPayload(payload *modelapi.Error) {
	o.Payload = payload
}
...
func (o *RequestBackupUploadNotFound) WithPayload(payload *modelapi.Error) *RequestBackupUploadNotFound {
	o.Payload = payload
	return o
}
