...
func (o *DownloadBackupBadRequest) WithPayload(payload *modelapi.Error) *DownloadBackupBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the download backup bad request response
func (o *DownloadBackupBadRequest) SetPayload(payload *modelapi.Error) {
	o.Payload = payload
}
...
func (o *DownloadBackupUnauthorized) WithPayload(payload *modelapi.Error) *DownloadBackupUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the download backup unauthorized response
func (o *DownloadBackupUnauthorized) SetPayload(payload *modelapi.Error) {
	o.Payload = payload
}
...
func (o *DownloadBackupNotFound) WithPayload(payload *modelapi.Error) *DownloadBackupNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the download backup not found response
func (o *DownloadBackupNotFound) SetPayload(payload *modelapi.Error) {
	o.Payload = payload
}
