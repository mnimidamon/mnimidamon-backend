...
// GetGroupComputersOfComputerParams contains all the bound params for the get group computers of computer operation
// typically these are obtained from a http.Request
//
// swagger:parameters getGroupComputersOfComputer
...
//
// To ensure default values, the struct must have been initialized with NewGetGroupComputersOfComputerParams() beforehand.
func (o *GetGroupComputersOfComputerParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetGroupComputersOfComputerParams) bindComputerID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
