...
type GetCurrentUserGroupComputersOK struct {
	...
	/*
	  In: Body
	*/
	Payload []*models.GroupComputer `json:"body,omitempty"`
}
...
func (o *GetCurrentUserGroupComputersOK) WithPayload(payload []*models.GroupComputer) *GetCurrentUserGroupComputersOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get current user group computers o k response
func (o *GetCurrentUserGroupComputersOK) SetPayload(payload []*models.GroupComputer) {
	o.Payload = payload
}
...
func (o *GetCurrentUserGroupComputersOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
	...
	if payload == nil {
		// return empty array
		payload = make([]*models.GroupComputer, 0, 50)
	}
...
func (o *GetCurrentUserGroupComputersUnauthorized) WithPayload(payload *models.Error) *GetCurrentUserGroupComputersUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get current user group computers unauthorized response
func (o *GetCurrentUserGroupComputersUnauthorized) SetPayload(payload *models.Error) {
	o.Payload = payload
}
