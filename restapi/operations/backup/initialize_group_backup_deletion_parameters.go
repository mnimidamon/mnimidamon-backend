...
// InitializeGroupBackupDeletionParams contains all the bound params for the initialize group backup deletion operation
// typically these are obtained from a http.Request
//
// swagger:parameters initializeGroupBackupDeletion
...
//
// To ensure default values, the struct must have been initialized with NewInitializeGroupBackupDeletionParams() beforehand.
func (o *InitializeGroupBackupDeletionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *InitializeGroupBackupDeletionParams) bindBackupID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *InitializeGroupBackupDeletionParams) bindGroupID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
