...
func (o *InitializeGroupBackupDeletionUnauthorized) WithPayload(payload *models.Error) *InitializeGroupBackupDeletionUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the initialize group backup deletion unauthorized response
func (o *InitializeGroupBackupDeletionUnauthorized) SetPayload(payload *models.Error) {
	o.Payload = payload
}
...
func (o *InitializeGroupBackupDeletionNotFound) WithPayload(payload *models.Error) *InitializeGroupBackupDeletionNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the initialize group backup deletion not found response
func (o *InitializeGroupBackupDeletionNotFound) SetPayload(payload *models.Error) {
	o.Payload = payload
}
