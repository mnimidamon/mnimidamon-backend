...
// DownloadBackupParams contains all the bound params for the download backup operation
// typically these are obtained from a http.Request
//
// swagger:parameters downloadBackup
...
//
// To ensure default values, the struct must have been initialized with NewDownloadBackupParams() beforehand.
func (o *DownloadBackupParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DownloadBackupParams) bindBackupID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DownloadBackupParams) bindGroupID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
