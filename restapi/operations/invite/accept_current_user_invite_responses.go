...
func (o *AcceptCurrentUserInviteOK) WithPayload(payload *models.Group) *AcceptCurrentUserInviteOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the accept current user invite o k response
func (o *AcceptCurrentUserInviteOK) SetPayload(payload *models.Group) {
	o.Payload = payload
}
...
func (o *AcceptCurrentUserInviteUnauthorized) WithPayload(payload *models.Error) *AcceptCurrentUserInviteUnauthorized {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the accept current user invite unauthorized response
func (o *AcceptCurrentUserInviteUnauthorized) SetPayload(payload *models.Error) {
	o.Payload = payload
}
